...
describe User do
  ...
  it "shoudl create a new isntance given valid attributes" do
    User.create!(@attr)
  end
  ...
  it "should accept valid emial addresses" do
  ...
  it "should reject invalid emial addresses" do
  ...
  it "should reject duplicate emial addresses" do
    User.create!(@attr)
    user_with_duplicate_email = User.new(@attr)
    user_with_duplicate_email.should_not be_valid
  end

  it "should reject emial addresses indentical up to case" do
  ...
  describe "micropost associations" do
    ...
    it "should ahve the right microposts in the right order" do
      @user.microposts.should == [@mp2, @mp1]
    end

    it "should destroy relevant posts when a user is destroyed" do
      @user.destroy
